...
public class TitlePropertyListener implements EventListener {
	...
	protected void activate(ComponentContext context) throws Exception {
		...
		session = repository.loginService("trainingservice",null);
		observationManager = session.getWorkspace().getObservationManager();
		
		observationManager.addEventListener(this, Event.PROPERTY_ADDED | Event.PROPERTY_CHANGED, "/content", true, null, 
